...
typedef struct
{
    signed char	forwardmove;	// *2048 for move // DSB-4 - explicitly signed
    signed char	sidemove;	// *2048 for move     // DSB-4 - explicitly signed
...
typedef struct player_s
{
    ...
    c_boolean		weaponowned[NUMWEAPONS];
    int			ammo[NUMAMMO];
    int			maxammo[NUMAMMO];
...
typedef struct
{
    c_boolean	in;	// whether the player is in game
