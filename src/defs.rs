...
pub type actionf_t = extern "C" fn (a: *mut u8, b: *mut u8);
...
pub struct sector_t {
    ...
    thinglist: *mut mobj_t,

    // thinker_t for reversable actions
    specialdata: *mut u8,

    linecount: i32,
    lines: *mut *mut line_t, // [linecount] size
}
...
pub struct mobj_t {
    ...
    pub mobjtype: mobjtype_t, // renamed from 'type'
